...
void inicializarFigura()
{
	...
	Vertice v2 =
	{ vec4(0.0f,0.5f,0.0f, 1.0f), vec4(0.0f,0.0f,1.0f,1.0f) };
	Vertice v3 =
	{ vec4(1.0f,-0.5f,0.0f, 1.0f), vec4(0.0f,1.0f,1.0f,1.0f) };
	figura->vertices.push_back(v1);
	figura->vertices.push_back(v2);
	figura->vertices.push_back(v3);
}
void inicializarFigura2()
{
	figura2 = new Modelo();
	Vertice v1 =
	{ vec4(-0.5f,-0.5f,0.0f,1.0f), vec4(1.0f,1.0f,1.0f,1.0f) };
	Vertice v2 =
	{ vec4(-0.5f,0.5f,0.0f,1.0f), vec4(1.0f,0.0f,1.0f,1.0f) };
	Vertice v3 =
	{ vec4(0.5f,0.5f,0.0f,1.0f), vec4(1.0f,1.0f,0.0f,1.0f) };
	Vertice v4 =
	{ vec4(0.5f,-0.5f,0.0f,1.0f), vec4(0.0f,1.0f,1.0f,1.0f) };
